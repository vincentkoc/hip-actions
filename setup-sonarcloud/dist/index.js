...
exports.SonarCloudClient = exports.SONAR_URL = void 0;
const axios_1 = __importDefault(__nccwpck_require__(7269));
exports.SONAR_URL = 'https://sonarcloud.io';
class SonarCloudClient {
    constructor(org, token) {
        this.org = org;
        this.token = token;
        this.axios = axios_1.default.create({
            baseURL: exports.SONAR_URL,
            timeout: 5000,
...
exports.SonarCloudClient = SonarCloudClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const sonar_1 = __nccwpck_require__(9908);
const core = {
...
const client = new sonar_1.SonarCloudClient(owner, token);
try {
